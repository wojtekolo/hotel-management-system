...
//        given
        ...
        Room room = RoomTestUtils.aValidRoom().type(deluxeType).operationalStatus(OperationalStatus.CLEAN).lifecycleStatus(LifecycleStatus.ACTIVE).name("101").floor(5).build();
