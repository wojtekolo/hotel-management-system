...
//import io.github.wojtekolo.hotelsystem.booking.api.validation.RoomStayUpdateError;
...
//import io.github.wojtekolo.hotelsystem.booking.service.*;
...
//
//    @Mock
//    private  BookingStayProcessor bookingStayProcessor;
//
//    @Mock
//    private BookingResourceLoader bookingResourceLoader;
//
//    @Mock
...
//                bookingStayProcessor,
//                bookingResourceLoader
//        );
//    }
//
//    @Test
...
//                    assertThat(roomStayEx.getStatusErrors())
//                            .extracting(RoomStayUpdateError::roomStayId, RoomStayUpdateError::status, RoomStayUpdateError::updateErrorCode)
//                            .containsExactlyInAnyOrder(tuple(2L, illegalStatus, RoomStayErrorCode.CANCEL_INVALID_STATUS));
//                });
//    }
//
//    @Test
...
//                    assertThat(bookingEx.getStatusErrors())
//                            .extracting(RoomStayUpdateError::roomStayId, RoomStayUpdateError::status, RoomStayUpdateError::updateErrorCode)
//                            .containsExactlyInAnyOrder(tuple(5L, RoomStayStatus.ACTIVE, RoomStayErrorCode.START_DATE_EDIT_INVALID_STATUS));
//
//                });
//    }
//
...
//    }
//
//    private Room mockRoom(Long id, BigDecimal customPricePerNight) {
//        Room room = RoomTestUtils.aValidRoom(RoomTestUtils.aValidType().customPricePerNight(customPricePerNight).build())
//                                 .id(id)
//                                 .build();
//        when(roomRepository.findById(id)).thenReturn(Optional.of(room));
//        return room;
