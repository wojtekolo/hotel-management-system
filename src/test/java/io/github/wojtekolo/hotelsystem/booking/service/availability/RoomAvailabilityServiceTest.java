...
//        given
        ...
        when(roomStayRepository.getOccupiedRangesForRoom(1L, RoomStayStatus.COLLIDING_STATUSES,
                ...
                .thenReturn(List.of(
                        new OccupiedRange(today.plusDays(3), today.plusDays(8)),
                        new OccupiedRange(today.plusDays(15), today.plusDays(22))
                ));

//        when
        RoomOccupancyResponse response = availabilityService.getRoomOccupancy(1L, today, today.plusDays(20));
